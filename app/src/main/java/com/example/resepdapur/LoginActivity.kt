...
class LoginActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        ...
        when (p0?.id) {
            ...
            R.id.btnSignUp -> signUp(
                edtFullNameSignUp.text.toString(),
                edtEmailSignUp.text.toString(),
                edtPwdSignUp.text.toString(),
                editor
            )
        }
    }

    private fun logiN(email: String, password: String, editor: SharedPreferences.Editor?) {
        if (email.equals("rheza@gmail.com") || password.equals("rheza123")) {
    ...
    private fun signUp(
        ...
        if (fullName == "Rheza Firmandha" || email == "rheza@gmail.com" || password == "rheza123"
        ) {
            startActivity(Intent(this, MainActivity::class.java))
        }
    }
